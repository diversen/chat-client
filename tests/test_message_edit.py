...
class TestMessageEdit(BaseTestCase):
    ...
    def test_update_message_endpoint(self):
        ...
        async def async_test():
            ...
            # Create a dialog
            dialog_response = await self.client.post('/chat/create-dialog', 
            ...
            message_response = await self.client.post(f'/chat/create-message/{dialog_id}', 
            ...
            assistant_response = await self.client.post(f'/chat/create-message/{dialog_id}', 
            ...
            update_response = await self.client.post(f'/chat/update-message/{message_id}', 
            ...
            messages_response = await self.client.get(f'/chat/get-messages/{dialog_id}', 
                cookies=self.session_cookies(user_id)
            )
    ...
    def test_update_message_validation(self):
        ...
        async def async_test():
            ...
            update_response = await self.client.post('/chat/update-message/999999', 
