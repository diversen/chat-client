...
function getChatElements() {
    return {
        ...
        reasoningPickerElem: getRequiredElement('reasoning-picker'),
        reasoningPickerDisplayElem: getRequiredElement('.reasoning-picker-display', 'querySelector'),
        selectReasoningEffortElem: getRequiredElement('select-reasoning-effort'),
