...
Revision ID: 125b55cb2626
Revises: 
Create Date: 2025-06-06 12:35:00.875051
...
def upgrade() -> None:
    ...
    op.create_index('idx_cache_key', 'cache', ['key'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_table('users')
    op.drop_table('token')
    op.drop_index('idx_cache_key', table_name='cache')
    op.drop_table('cache')
    # ### end Alembic commands ###
